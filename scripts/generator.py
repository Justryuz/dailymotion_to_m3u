...
def process_channel_info(channel_info_path):
    ...
    try:
        ...
        logger.error(f"Error processing dailymotion_channel_info.txt: {e}")
...
def main():
    ...
    channel_info_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../dailymotion_channel_info.txt'))
